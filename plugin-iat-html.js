var jsPsychIatHtml = (function (jspsych) {
  ...
  class IatHtmlPlugin {
      ...
      trial(display_element, trial) {
          var html_str = "";
          html_str +=
              "<div style='position: absolute; visibility: visble; height: 20%; width: 100%; margin-left: auto; margin-right: auto; top: 42%; left: 0; right: 0'><p id='jspsych-iat-stim'>" +
                  trial.stimulus +
                  "</p></div>";
          ...
          const after_response = (info) => {
              ...
              if (response.key == null) {
                  ...
                  response.rt_first_response = info.rt;
              }
